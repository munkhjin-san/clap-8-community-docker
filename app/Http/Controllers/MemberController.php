...
価値を創造し、経済や社会を発展させることができます。イノベーションには、企業や社会をより良いものに変えるためのチャレンジ精神や、一般常識に捕らわれない多角的な発想が必要です。"
    ...
    public function get_kadai_reviev(Request $request){
        ...
        //     $chat_res = new messageRecord;
              
        //     $chat_res->record_id = $request->record_id;
        //     $chat_res->user_id = 823;
            
    
        //     $chat_res->message =  $result->message->content; 
        //     $chat_res->created_at = now();
        //     $chat_res->save();
        // }
    }
