...
class ShiftService
{
    ...
    public function requiresProjectForApproval(shiftRecord $shift): bool
    {
        ...
        return !in_array((int) $type->id, shiftType::idsFor([shiftType::CATEGORY_DAY_OFF, shiftType::CATEGORY_LEGAL_HOLIDAY]), true)
            && (int) $type->full_day !== 2;
    }

    private function scopeNeutralShiftRecords($query): void
    {
        $query->whereIn('shift_type', shiftType::idsFor([shiftType::CATEGORY_DAY_OFF, shiftType::CATEGORY_LEGAL_HOLIDAY]))
