...
class ReconcilePaidLeaveUsages extends Command
{
    ...
    public function handle(PaidLeaveLedgerService $paidLeaveLedger): int
    {
        ...
        $this->table(['Metric', 'Count'], [
            ...
            ['Kintone-reflected usages skipped', $summary['skipped_imported_kintone_usage']],
            ...
            ['Kintone-reflected usages removed', $summary['removed_imported_kintone_overlap_usages']],
