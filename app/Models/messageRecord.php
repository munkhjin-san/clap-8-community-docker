...
{   
    ...
    {
        return $this->belongsToMany(User::class, 'message_check_users')->withPivot(['checked'])->select('users.id', 'users.name', 'users.a_path', 'users.a_version', 'users.deleted_at');
    }
    public function reactedUsers()
    {
        return $this->belongsToMany(User::class, 'message_reacted_users')->select('users.id', 'users.name', 'users.a_path', 'users.a_version', 'users.deleted_at');
    }   
    ...
    public function user(){
        return $this->belongsTo(User::class)->withTrashed()->select('id', 'a_path', 'a_version', 'name', 'deleted_at');
    }
