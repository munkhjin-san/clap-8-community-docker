...
<script setup>
    ...
    const previewFile = (file, index) => {
        ...
        const files = file_list.map(fileData => ({
            ...fileData,
            file_path: `/cdn/support_files/${fileData.id}_${fileData.user_id}_${fileData.record_id}.${fileData.extension}`,
            doc_path: `/support_files/${fileData.id}_${fileData.user_id}_${fileData.record_id}.${fileData.extension}`
        }));
