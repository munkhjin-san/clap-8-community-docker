<template>
    <article class="border border-solid rounded border-[var(--bg3)] p-[18px]">
        ...
        <div v-if="mustCheck" @click="markAsRead" class="cursor-pointer mt-5 flex items-center gap-2 bg-[var(--bg3)] px-3 py-2 text-[12px] text-[var(--primary-color)] rounded-full w-fit">
            ...
            <Transition name="switchState">
                ...
                <span v-else class="text-[12px] text-[gray]">未読</span>
            </Transition>
        </div>
    </article>
</template>
