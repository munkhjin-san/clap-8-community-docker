<template>
    <div class="rt">
        <div :class="['boardMenuContainer', {'active': active} ]" @click.stop="show"> 
            <svg v-if="type == 'share'" style="margin:auto;min-width: 3px;" xmlns="http://www.w3.org/2000/svg" height="13" id="Layer_2" class="dot-menu" data-name="Layer 2" viewBox="0 0 18.46 18.25">
            ...
            <svg v-else version="1.1" xmlns="http://www.w3.org/2000/svg" height="13" class="dot-menu" viewBox="0 0 7 32" style="margin:auto;min-width: 3px;">
