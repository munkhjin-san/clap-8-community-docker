<template>
    <div id="cMonthPicker" class="monthPicker">
        ...
        <div id="taskYearPicker" :style="from == 'work' ? 'right: -32px;' : ''" class="month-grid" v-if="$store.state.menu.id == 42 && $store.state.menu.name == 'taskYearPicker'">
            <div class="grid-container">
                ...
                <div @click.stop="pickerIs = 'year'" class="grid-item grid-picker">{{ this.year }}年</div>
...
import moment from 'moment'
    export default {        
        props: ['selectedMonth', 'selectedYear', 'from'],
        emits: ['setDate'],
        data(){
            return{
