<template>
    <div class="hb-menu" @click="$store.commit('setSideMenuView', !$store.state.sideMenuView)">
        <svg v-if="!$store.state.sideMenuView" class="dot-menu" version="1.1" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
        ...
        <svg v-else class="dot-menu" version="1.1" width="15" height="15" viewBox="0 0 20 32" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- <div class="hb-badge" v-if="badge && !this.$store.state.sideMenuView"></div> -->
        <!-- <div style="top: -3px;right: -5px;left: auto;" class="notification" v-if="badge && !this.$store.state.sideMenuView">{{ badge > 9 ? '9+' : badge }}</div> -->
...
export default{
    computed:{
        ...
        shouldView(){
            return this.badge && !this.$store.state.sideMenuView && !this.$store.state.user.footer_view
        }
    }
}
</script>