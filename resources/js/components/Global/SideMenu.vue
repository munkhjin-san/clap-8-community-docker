        ...
        <div class="side-menu-inner" v-if="auth.user">    
            ...
            <router-link :to="{name: 'board'}" :class="['side-menu-route', { selectedRoute: selectedRoute == 'board' || selectedRoute == 'room'}]">
                <div class="side-menu-route-inner">               
                    ...
                    <span v-if="sideMenuView.active">チャット</span>
            ...
            <router-link :to="{name: 'remind'}" :class="['side-menu-route', { selectedRoute: selectedRoute == 'remind'}]">
                <div class="side-menu-route-inner">               
                    <svg class="side-app-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" version="1.1" x="0px" y="0px" width="20" height="20" viewBox="0 0 26 29" enable-background="new 0 0 26 29" xml:space="preserve">
            ...
            <router-link :to="{name: 'project'}" v-if="!auth.isPartner && auth.user" :class="['side-menu-route', { selectedRoute: isActive}]">
                <div class="side-menu-route-inner">   
                    ...
                    <span v-if="badge.projectTotal" class="side-notification" style="top:6px; left:37px">{{ badge.projectTotal }}</span>      
                </div>                
            </router-link>
            ...
            <router-link :to="{name: 'contact'}" :class="['side-menu-route', { selectedRoute: route.path.includes('contact')}]">
                <div class="side-menu-route-inner">   
                    <svg class="side-app-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.23 29.26" style="height: 21px;min-width:17px;"> 
                        ...
                        <path class="cls-1" d="M17.92,18.54c-2.62-3.41-8.14-3.38-10.77,0-.43.55-.76,1.19-.94,1.87-.11.43.1.89.52,1.07.47.21,1.03-.03,1.22-.51.36-.83,1.03-1.54,1.86-2.03,2.46-1.51,6.11-.63,7.36,2.02.44,1,1.92.53,1.69-.55-.17-.69-.5-1.33-.92-1.88Z"/>
                        <path class="cls-1" d="M28.23,20.18c.02-1.15-.95-2.17-2.09-2.22-.14,0-.29,0-.44,0-.12,0-.21-.1-.2-.22.04-.46.06-.91.08-1.37.05-1.59.02-3.18-.06-4.76,0-.12.09-.21.2-.21h0c.19,0,.42.01.63-.02,1.06-.14,1.89-1.12,1.88-2.19,0-.08,0-.51,0-.6.02-1.15-.95-2.17-2.09-2.22-.12,0-.26,0-.4,0-.18,0-.33-.15-.32-.32,0-.7.02-2.14.02-2.14.02-.52,0-1.06-.19-1.55-.47-1.36-1.87-2.31-3.3-2.26-3.88-.03-9.32-.05-13.22-.08-.54.03-5.47-.09-5.86.05C1.98.24,1.18.76.67,1.49.23,2.08,0,2.83,0,3.57c-.02,5.49,0,15.59,0,21.08,0,.28,0,.84,0,1.11,0,1.88,1.6,3.5,3.48,3.5,4.6,0,13.09-.06,17.72-.08.46-.01.91.03,1.42-.06,1.15-.19,2.15-1.01,2.59-2.08.21-.5.27-1.06.25-1.59,0,0-.01-2.36-.02-2.46.1,0,.19,0,.27,0,.19,0,.42.01.63-.02,1.06-.14,1.89-1.12,1.88-2.19,0-.08,0-.51,0-.6ZM26.02,8.26c.08,0,.16.05.22.11.06.06.09.14.09.22v.48s0,.12,0,.12c0,.2-.17.35-.37.34-.16,0-1.03.02-1.2.02l-1.87.05c-.2.02-.43-.16-.47-.41h.03s.02-.48.02-.48c0-.07,0-.17.03-.24.06-.16.22-.27.39-.27.02,0,.27,0,.31,0l.96.02,1.87.03ZM23.61,25.75c0,.73-.59,1.39-1.31,1.5-5.07.04-13.65-.07-18.72-.06-.79.03-1.5-.66-1.48-1.45.01-5.86.01-16,0-21.86v-.31s0-.04,0-.04c-.02-.67.5-1.3,1.16-1.43,0-.06,5.29-.04,5.46-.05,3.63-.01,8.98-.06,12.59-.08.26,0,.83-.03,1.06.03.71.13,1.27.8,1.27,1.52v.08s0,.31,0,.31c0,0,.01,1.3.02,2.02,0,.26-.21.48-.47.48h0c-.19,0-.42,0-.62.04-1.02.16-1.81,1.11-1.78,2.14,0,.08.01.51.02.6,0,0,.03,0,.03,0-.05,1.08.85,2.07,1.93,2.14.17.01.38.02.54.03.14,0,.25.13.25.27-.03.47-.04.94-.05,1.41-.04,1.52-.06,3.03.06,4.55.02.22-.15.42-.38.42h0c-.19,0-.42,0-.62.04-1.02.16-1.81,1.11-1.78,2.14,0,.08.01.51.02.6,0,0,.03,0,.03,0-.05,1.08.85,2.07,1.93,2.14.29.02.57.02.85.03,0,.03-.02,2.5-.02,2.5,0,0,0,.3,0,.3ZM25.96,21.12c-.16,0-1.03.02-1.2.02l-1.87.05c-.2.02-.43-.16-.47-.41h.03s.02-.48.02-.48c0-.07,0-.17.03-.24.06-.16.22-.27.39-.27.02,0,.27,0,.31,0l.96.02,1.87.03c.08,0,.16.05.22.11.06.06.09.14.09.22v.48s0,.12,0,.12c0,.2-.17.35-.37.34Z"/>
                    </svg>
                    <span v-if="sideMenuView.active">コンタクト</span>                  
                </div>
            ...
            <router-link :to="adminRoute" v-if="[608, 610].includes(auth.activeUser.id) || auth.activeUser.position_id <= 6" :class="['side-menu-route', { selectedRoute: route.path.includes('admin_control')}]">
                <div class="side-menu-route-inner">   
                    <svg class="side-app-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" version="1.1" x="0px" y="0px" style="width:auto; height: 20px;min-width:17px;" viewBox="0 0 30 31" enable-background="new 0 0 30 31" xml:space="preserve">
                    ...
                    <span v-if="sideMenuView.active">管理画面</span>                    
                </div>                
            </router-link> 
