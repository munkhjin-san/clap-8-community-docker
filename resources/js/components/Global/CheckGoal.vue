    ...
    <div class="overlay">
        <div class="chatCreate kadaiCreate scrollable">
            <div class="recordFormTitle" style="display:flex;margin-bottom: 10px;">
                <div @click="router.back()" style="margin: 2px 10px 0 0;" v-if="responsive.mobile">  
                    <Back/>             
                </div>  
                <p>プロジェクト人事承認</p>
                <div v-if="!responsive.mobile" class="cursor-pointer" @click="router.back()" style="position:unset; margin:auto 0 auto auto">
