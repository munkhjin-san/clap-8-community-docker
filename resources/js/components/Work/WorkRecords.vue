                ...
                <div class="footer-row" v-for="(user, index) in usersData" :key="index">
                    <div @click="downloadCSV()" class="footer-cell cursor-pointer" >
                        <div style="display:flex; justify-content: center; align-items: center; gap:10px">
                            <p v-if="index === 0">集計</p>
                            <svg v-if="index === 0 && (auth_user.id == 608 || auth_user.position_id == 6)" xmlns="http://www.w3.org/2000/svg" id="Layer_2" data-name="Layer 2" viewBox="0 0 21.76 21.79" fill="#fff" width="15" height="15">
                                <g id="logo">
