        ...
        <div class="work-modal-inner" @mousedown.stop>
            ...
            <div class="attendance-wrapper">
                ...
                <div class="attendance-row">
                    ...
                    <div class="attendance-value">
                        <span>{{ overTime(attendanceData.over_time) }}</span>
                    </div>
                </div>
                <div class="attendance-row">
                    <div class="attendance-title">
            ...
            <button class="l-button cursor-pointer" style="margin-top:30px;" :disabled="disableButton" @click="attendanceConfirm()">
                <span v-if="!loading">{{buttonTexts}}</span>
...
<script>
    ...
    export default{
        props: ['selectedYear', 'selectedMonth', 'attendanceData'],
        data(){
            return{
                loading: false,
        ...
        methods: {
            ...
            shiftDay(data){
                ...
                let hours = (data.user.work_time_day * data.shift_count)/60 + '時間'
                return `${days} / ${hours}`
            },
            workedDay(data){
            ...
            annualTime(data){
                return (data.annual_leave * data.user.work_time_day)/60 + '時間' 
            },
            holidayWork(data){
            ...
            attendanceConfirm(){
                ...
                const params = {
                    ...
                    shift_working_hours: this.attendanceData.user.work_time_day * this.attendanceData.shift_count,
                    ...
                    annual_leave: this.attendanceData.annual_leave,
                    ...
                    over_time: this.attendanceData.over_time,
                    night_work_time: 0,
