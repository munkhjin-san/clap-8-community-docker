            ...
            <div class="file-main-section">
                ...
                class="fletty mblist">
                    <div class="innerContainer">            
                        ...
                        <div @click.stop="menu.setMenu( {name: 'fileContextMenu', id: file.id})" :class="{kebabActive : menu.name == 'fileContextMenu' && menu.id == file.id}" class="boardMenuContainer" style="margin-right: 5px;">                                    
                        ...
                        <Transition name="modalFade">                    
                            <div v-if="menu.name == 'fileContextMenu' && menu.id == file.id" id="fileContextMenu" class="boxMenuComment cursor-pointer" style="z-index:2;top:30px;right:30px;position:absolute;background-color: unset;user-select:none;">
                                <div>
                                    ...
                                    <div v-if="fileMenuLayer == 0" style="position:absolute;top:-5px;right:5px;overflow:hidden;box-shadow: rgb(60 64 67 / 30%) 0px 1px 2px 0px, rgb(60 64 67 / 15%) 0px 2px">
                                        <ul style="min-width:110px"> 
                                            ...
                                            <li v-if="file.message_id && file.message_id > 0" @click="jumpToMessage(file)" class="boxMenuItems cursor-pointer">メッセージに移動</li> 
                                        </ul>
                                    </div>
                                    </Transition>
                                </div>                                                                        
