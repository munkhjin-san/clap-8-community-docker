                ...
                <div class="file-header__inner">
                    <div class="mem-search-area" style="width:100%;">
                        <div class="searchBarInner memberSearchBar" style="width: 100%;margin-left: 0;">   
                            <input @input="setKeyWord" id="fileSearchInput" v-model="keyword" class="searchBarArea searchInputArea memberSearch" :placeholder="$t('searchFiles')" type="text" style="margin: 0;width:100%;"/>
