    ...
    <div @mousedown="closeTaskModal(false)" class="overlay" style="z-index:24">        
        <div class="chatCreate scrollable" style="position:relative" @mousedown.stop>            
            ...
            <div class="recordFormTitle" style="display:flex;">
                <p>{{ editTaskData ? $t('editTask') : $t('createTask')}}</p>
                <div style="margin-left:auto;"> 
                    <div @click="closeTaskModal(false)" class="cursor-pointer" style="position:unset;">
...
export default {
    ...
    data() {      
        return { 
            ...
            taskEndDate: this.editTaskData && this.editTaskData.end_at?  moment(this.editTaskData.end_at).format('YYYY-MM-DD') : '',
    ...
    methods: { 
        async validation(){              
            ...
            try {                    
                ...
                let checkRef = ['taskUsers', 'taskContent'];
                let result = true
