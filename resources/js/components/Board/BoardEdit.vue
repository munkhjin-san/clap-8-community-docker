                                ...
                                <div style="width: fit-content;padding: 15px;margin: auto;">
                                    <div id="boardIconPreview" class="iconPreview">
                                        ...
                                        <div v-if="upFileArray.length" style="position:absolute;">
                                            ...
                                            <BoardIcon :item="item" :imgClass="'boardNormalIcon'" :imgStyle="'width:45px;height:45px'"/>
    ...
    export default {
        ...
        methods:{
            ...
            editBoard(){
                ...
                var path = this.item.icons ? 'board_' + this.item.icon_id + '.' + this.item.icons.extension : [];
