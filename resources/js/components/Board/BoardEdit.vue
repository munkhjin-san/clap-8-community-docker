    ...
    <div @mousedown="closeModal" class="overlay" style="z-index: 27;font-size:14px">
        <div style="width: 100%;height: 100%;display: flex;align-items: center;justify-content: center;">  
            <div id="editModal" class="chatCreate" ref="editModal" @mousedown.stop>
                ...
                <div style="height: -webkit-fill-available;overflow:hidden auto;background: inherit;">
                    <div class="si-box">
                        <ShortInput 
                            name="boardTitle" 
                    ...
                    <div class="si-box">
                        <p style="font-size: 14px;margin: 15px 0px;">ボードアイコン</p>
                        <div style="text-align:center;padding: 10px;position:relative;border:solid thin var(--primary-color)">                        
                            ...
                            <div v-else>
                                <p style="margin:auto 10px auto 0;">アイコンプレビュー</p>
                                <div style="width: fit-content;padding: 15px;margin: auto;">
                                    <div id="boardIconPreview" class="iconPreview">
                                        <div v-if="newIcon == 'initial'" id="iconPreviewInnerText" class="iconPreviewInner" v-html="previewText"></div>
