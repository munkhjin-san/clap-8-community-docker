            ...
            <div class="message-top-block">
                ...
                <div class="messageIconContainer">
                    ...
                    <div v-if="message.deleted_at == null || reminded" title="リマインド" class="boardMenuContainer" @click="remind(message)">
                        <svg :style="{ opacity : reminded ? 1 : 0.5 }" xmlns="http://www.w3.org/2000/svg" class="m-auto dot-menu" version="1.1" x="0px" y="0px" height="13" viewBox="0 0 27 29" enable-background="new 0 0 26 29" xml:space="preserve">
