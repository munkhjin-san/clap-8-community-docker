    ...
    <div class="overlay" style="z-index:90">            
        <div id="quotAreaModal" style="padding:20px;max-width:90%;max-height:85%;width:fit-content;background:var(--background-color);overflow: auto;color:var(--primary-color)">  
            <div style="width:100%;display:flex;">
                <p style="padding-bottom: 20px;line-height: 0.7;margin-right: 30px;" class="copyareaTitle">転送するテキストを選択してください</p>
            ...
            <textarea @focus.once.prevent v-model="advancedQuotMessage" readonly ref="quotAreaEditor" style="overflow: hidden;letter-spacing:normal !important;min-width:100%" class="copyMessageArea"></textarea>
            <div @click="advancedQuotFinish" style="margin: 20px auto auto auto;width:auto;user-select:none;" class="groupEditButton cursor-pointer">引用</div>                        
        </div>                                        
    </div>
</template>
<script setup>
