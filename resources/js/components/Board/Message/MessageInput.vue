    ...
    <div id="footArea" 
        ...
        v-show="board">
                ...
                <div style="display:inline-block;z-index:5;width:100%;box-sizing: border-box;padding: 10px;position:relative">
                    ...
                    <div id="attachArea" title="添付ファイル" style="position: absolute; bottom: 13px;">
                            <div style="display:inline-block">
                                <label for="sharedfile" class="cursor-pointer">                                       
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="27" viewBox="0 0 27 32" style="fill: var(--third-color);">
                    ...
                    <div class="typeAreaOuter" style="">
                        ...
                        <div
                            ...
                            :class="['typeBoxArea',  'boardTypeArea', {maxLengthAlert: charLength >= 5000}, {hasText: messageInputArea?.innerText?.length}]"
                            >
                        </div>
                        
                        <div class="typeCommandBar">
                            <div class="pc" title="絵文字" @click.stop="menu.setMenu( {name: 'EmojiPicker', id: 1002})">                                          
                            ...
                            <div @click="editWithAi" title="AI分析">                                           
                            ...
                            <div @click="commentSendConfirm(1)" title="下書き保存">
                                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_2" data-name="Layer 2" width="20" height="20" viewBox="0 0 16.79 29.72" style="fill: var(--third-color);">
                                    ...
                                    <path class="cls-1" d="m9.36,24.82c.61-.69,1.22-1.37,1.82-2.06.61-.69,1.2-1.38,1.8-2.07.6-.69,1.2-1.39,1.79-2.08.59-.7,1.18-1.4,1.77-2.11.29-.35.27-.86-.06-1.19s-.9-.32-1.25.01c-.65.63-1.3,1.26-1.95,1.9-.65.65-1.3,1.29-1.94,1.94-.47.47-.94.95-1.41,1.42-.11.12-.31.03-.31-.13,0-.75.01-1.49.01-2.24,0-1.91-.01-3.82-.02-5.73l-.03-2.87-.04-2.87c-.03-1.91-.07-3.82-.13-5.73C9.39.45,8.92,0,8.34,0s-1.03.49-1.04,1.06c-.05,1.9-.08,3.8-.1,5.7l-.03,2.87v2.87c-.01,1.91-.02,3.82,0,5.73,0,.74.02,1.48.03,2.23,0,.16-.2.25-.31.13-.47-.47-.94-.94-1.4-1.41-.65-.65-1.3-1.29-1.95-1.94l-.98-.96-.99-.96c-.36-.34-.94-.35-1.3.03-.33.34-.32.89-.02,1.25l.87,1.02.9,1.04c.6.69,1.2,1.38,1.81,2.07.61.69,1.21,1.37,1.82,2.06.61.68,1.47,1.71,1.94,2.14s1.3.41,1.76-.11Z"/>
                                </svg>
                            </div>
                                <Transition name="modalFade">
