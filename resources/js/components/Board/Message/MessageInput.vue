                    ...
                    <div class="typeAreaOuter" style="">
                        ...
                        <div class="typeCommandBar">
                            <div class="message-icon-outer">
                                ...
                                <div id="attachArea" title="添付ファイル" class="message-icon-wrapper">
                                ...
                                <div @click="editWithAi" title="AI分析" class="message-icon-wrapper" style="margin-right: -2px;width:28px">                                           
                                    <!-- <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 30" width="22" height="22" style="fill: var(--third-color);" :class="[{'rotate-gtp' : editing}]">
                                    ...
                                    <svg width="30" height="30" viewBox="0 0 721 721" fill="var(--third-color)" xmlns="http://www.w3.org/2000/svg" :class="[{'rotate-gtp' : editing}]">
