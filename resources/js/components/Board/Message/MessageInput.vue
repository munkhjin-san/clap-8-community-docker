    ...
    <div id="footArea" 
        ...
        v-show="board">
                ...
                <div style="display:inline-block;z-index:5;width:100%;box-sizing: border-box;padding: 10px;position:relative">
                    ...
                    <div class="pc" title="絵文字" style="position:absolute;right: 140px;bottom: 18px;cursor: pointer;" @click.stop="menu.setMenu( {name: 'EmojiPicker', id: 1002})">                                            
                    ...
                    <div @click="editWithAi" title="AI分析" class="ai-loader-button">                                           
                   ...
                   <div id="attachArea" title="テンポファイル" class="attach-area">
                    ...
                    <div class="temp-save cursor-pointer" @click="commentSendConfirm(1)" title="下書き保存">
