        ...
        <div v-if="selectedTopic && selectedTopic.active == 1" :style="{height: route.name == 'basic'  ? '100%' : '0'}">
            <div style="height: 100%; overflow: hidden auto;">
                ...
                <div class="topic-container" style="margin: 25px 0;">
                    ...
                    <div @click="sectionsCompleted && portfolioStatus < 1 ? router.push({name: 'episode'}) : router.push({name: 'summary'})" :class="['topic-item', {'inactive-theme' : !sectionsCompleted}]" style="flex-direction: row;align-items: center;justify-content: start;gap:5px;">
