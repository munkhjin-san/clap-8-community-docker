            ...
            <div>
                ...
                >                            
                    <div class="topic-title flex" style="gap:5px">
                        <div v-if="topic.lesson_portfolio?.status == 3 || materialStatus(topic.materials) " style="background-color: rgb(100, 188, 68); width: 18px; height: 18px; display: flex; border-radius: 50%; margin: auto 3px; min-width: 18px;">
