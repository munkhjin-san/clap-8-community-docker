        ...
        <div style="display:flex;min-height:40px;width: 100%;max-height: 40px;">
            ...
            <div style="width: 123px;display:flex;min-height:40px;justify-content: flex-end;fill:var(--primary-color);">
                ...
                <div @click="goTask" style="width:40px;height:40px;display:flex;border-radius:50px;position: relative;" @touchstart="$event.currentTarget.classList.add('mobileHeaderButton')">
                    ...
                    <p v-if="taskBadge" class="notification" style="top: 0px;right: 5px;z-index: 5;left: auto;top: 5px;height: 12px;min-width: 12px;font-size: 9px;line-height: 12px;">{{ taskBadge}}</p> 
                </div>
