        ...
        <div style="display:flex;min-height:40px;width: 100%;max-height: 40px;">
            ...
            <div style="width: 123px;display:flex;min-height:40px;justify-content: flex-end;fill:var(--primary-color);">
                <div @click="privateSearch" style="width:40px;height:40px;display:flex;border-radius:50px">
                    <svg class="m-auto" version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 32 32">
                ...
                <div @click="goTask" style="width:40px;height:40px;display:flex;border-radius:50px;position: relative;">
                    ...
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 37 32" class="m-auto" >
                ...
                <div @click="goFile" style="width:40px;height:40px;display:flex;border-radius:50px">
                    <svg width="20" height="20" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 39 32" class="m-auto" >
                ...
                <div @click="goForm" style="width:40px;height:40px;display:flex;border-radius:50px">
                    <svg xmlns="http://www.w3.org/2000/svg" class="m-auto" width="20" height="20" viewBox="0 0 25.51 22.62">
