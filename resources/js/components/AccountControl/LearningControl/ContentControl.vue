    ...
    <div class="lcontrol">        
        <div style="padding: 0 20px">
            <div v-for="lesson in lessons" class="lesson-preview">
                ...
                <div class="boardMenuContainer cursor-pointer" @click.stop="menu.setMenu({name: 'topicBoxMenu', id: lesson.id})" @touchstart.stop style="position: absolute;right: 10px;top: 10px;">                                            
                ...
                <div id="topicBoxMenu" class="boxMenu boardMenuIcon" v-if="menu.name == 'topicBoxMenu' && menu.id == lesson.id" style="top: 25px;right: 40px;z-index:6;">
                    <ul>
