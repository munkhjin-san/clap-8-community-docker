    ...
    <div class="overlay" @mousedown="closeModal(false, null)">                         
        <div class="chatCreate" @mousedown.stop style="overflow: hidden auto;">     
            ...
            <div class="si-box" style="height: 70%;">
                <div style="font-size: 14px;margin-bottom: 15px;">要約の内容</div>
                                        ...
                                        <div :key="index" v-for="(question, index) in questions">     
                                            <div class="flex items-center gap-[10px]">
                                                <div class="flex items-center w-full">
                                                    <input placeholder="質問" class="custom-o-input w-full" type="text" ref="radios" v-model="question.question" @keyup.enter="addQuestion()"/>
                                                </div>
                                                <div class="flex">
                                                    ...
                                                    <div title="質問削除" @click="removeQuestion(index)" class="h-[30px] w-[30px] cursor-pointer flex items-center justify-center">
...
import { useRoute } from 'vue-router';
    ...
    const questions = ref(props.summaryData?.questions.length ? props.summaryData.questions.map(({ id, question }) => ({ id, question })) : [
                {
                    id: null,
                    question: '',
                }
