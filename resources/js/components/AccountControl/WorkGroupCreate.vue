<template>
    <div class="chatCreate scrollable" style="height:auto">
        <div id="postCreateWindow">
            <div class="workGroupFormHeader" style="display:flex;">
            ...
            <Form v-slot="{ errors }" ref="form">  
                <div class="input-wrapper">
                    <span style="z-index: 1;background-color:var(--background-color);" class="form-plc smallPlc">グループ名</span> 
                    <div class="w-100">
                ...
                <div class="input-wrapper mt-20">
                    <span style="z-index: 1; background-color:var(--background-color);" class="form-plc smallPlc">メンバー</span> 
                    <div class="w-100">
                        <div class="input-inner-wrapper">
                ...
                <div v-if="editFlag" style="margin-top:30px;" class="l-button cursor-pointer" @click="editworkGroupSend()" :disabled="processing">
                ...
                <div v-else style="margin-top:30px;" class="l-button cursor-pointer" @click="workGroupAdd()" :disabled="processing">
                    <span v-if="!processing">保存する</span>
                    <div v-if="processing" id="loaderMini">
                        <div class="spinner-mini" style="border: 4px #ffffff solid;border-top: 4px black solid;"></div>
                    </div>
