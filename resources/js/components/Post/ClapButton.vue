<template>
    <div class="post-footer-wrap" @click="sendClap">                       
        <svg class="clap-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41 32" :fill="iconFill" :style="{cursor: !canClap ? 'not-allowed' : 'pointer'}">
        ...
        <p v-if="item.claps.length" style="line-height: 1;">{{item.claps.length}}</p>                                                              
    </div>  
</template>
<script>
    export default {
