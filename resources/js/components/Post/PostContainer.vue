    ...
    <div class="post-root" v-if="auth.id == auth.activeUser.id">
        ...
        <div class="post-container scrollable" @scroll="scrollListen">
            <div class="p-tag-container">
                ...
                <div v-else :class="['p-tag-wrap', {'p-tag-expand' : viewAccordian}]">
                ...
                <div style="padding: 0px 20px 10px 20px;display: flex;justify-content: center;gap: 10px;align-items: center;" @click="viewAccordian = !viewAccordian">                                      
                    <div title="すべて表示する" class="selector-accordion-el">
                        <svg v-show="tagLoading > 0" class="dot-menu" version="1.1" width="11" height="11" :class="['selector-accordion-inactive' , {'selector-accordion-active' : viewAccordian}]" viewBox="0 0 20 32" xmlns="http://www.w3.org/2000/svg">
