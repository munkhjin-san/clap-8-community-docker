<template>
    <div :class="className" style="">
        <div style="width:100%;display:flex;">
            <div class="searchBarInner" :style="{width: $store.state.mobile || className == 'newChatMemberSearch' ? '100%' : '25%',marginLeft: 'auto'}">   
                <input name="postSearchBar" @input="setKeyWord" v-model="keyword" @focus="$emit('focus')" @blur="$emit('blur')" class="searchBarArea searchInputArea memberSearch" :placeholder="customPlaceHolder ? customPlaceHolder : $t('searchInMembers')" type="search" style="margin: 0;width:100%;"/>
...
<script>
    export default {
        ...
        methods: {
            cancelSearch(){
                this.keyword = ''
                this.$emit('searchStart', this.keyword)
            },
            setKeyord(){
