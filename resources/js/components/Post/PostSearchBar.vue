    ...
    <div :class="className" style="">
        <div style="width:100%;display:flex;">
            <div class="searchBarInner" :style="{width: $store.state.mobile || className == 'newChatMemberSearch' ? '100%' : '25%',marginLeft: 'auto'}">   
                <input @input="setKeyWord" v-model="keyword" @focus="searchStart" class="searchBarArea searchInputArea memberSearch" :placeholder="customPlaceHolder ? customPlaceHolder : $t('searchInMembers')" type="text" style="margin: 0;width:100%;"/>
