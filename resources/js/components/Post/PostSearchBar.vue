    ...
    <div :class="className">
        <div class="w-full flex">
            <div class="searchBarInner" :style="innerStyle">   
                ...
                <div @click.stop="cancelSearch" v-if="keyword.length && searching == 0" class="searchBarCancelButton" style="right: 0;">
                ...
                <div v-if="searching && searching > 0" class="searchBarCancelButton" style="right: 0;z-index:1">
...
import { computed, watch } from 'vue';
    ...
    const keyword = useDebouncedRef(props.initialValue || '')
    const cancelSearch = () => {
        keyword.value = ''
        emit('searchStart', keyword.value)
    }
    watch(keyword, (val) => {
        emit('searchStart', val)
    })
</script>
<style>
