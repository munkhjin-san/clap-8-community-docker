<template>
    ...
    >
        <template #icon>
            <svg class="side-app-icon mr-2" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 32" style="height: 18px; min-width: 17px; overflow: visible;">
        ...
        <template #default="{ parentElement }">
