    ...
    <div class="help-content-container">
        <div class="help-content-inner">
            <div style="padding: 15px;">
                ...
                <div>
                    <div>
                        <!-- <a href="#create-new-accoun">{{ $t('help.accountManagementContents.') }}</a> -->
                        <div>
                            <div v-for="section in $tm('help.accountManagementContents')" :key="section.title" style="margin-top: 20px;line-height: 1.5;">
                                <h1>{{ section.title }}</h1>
                                <ul>
                                    <li style="padding: 10px 0;" v-for="(step, index) in section.steps" :key="step" v-html="`${index + 1}. ${$rt(step)}`"></li>
                                </ul>
                            </div>
                        </div>
