    ...
    <div class="main-bar">
        ...
        <div style="overflow: hidden;">
            ...
            <div class="bar01">
                ...
                <div class="bar05 gap-2" v-if="auth.isEmployee && UserAllData?.refresh_current_balance !== null && canViewRefreshHistory">
                    <div @click="emit('openHistory')" title="リフレッシュ" class="flex gap-1 items-center cursor-pointer">
                        ...
                        <p>{{ UserAllData?.refresh_current_balance }}円</p> 
                    </div>
...
import { useApi } from '@/composables/api';
    ...
    const canViewRefreshHistory = computed(() => {
        return !!(props.UserAllData && auth.id && (props.UserAllData.id === auth.id || auth.isAdmin))
    })
