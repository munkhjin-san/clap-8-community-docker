<template>
    <div class="overlay" @mousedown="router.push({name: 'dashboard', params: { type: 'notice'}})">            
        <div @mousedown.stop ref="detailWindow" class="chatCreate scrollable" style="padding-top: 0;">
            <div class="recordFormTitle" style="align-items: baseline;">
                ...
                <div style="margin-left: auto;padding-left: 20px;display: flex; align-items: center;position: relative;">
                    ...
                    <div @click="router.push({name: 'dashboard', params: { type: 'notice'}})" class="m-close-button" style="position: unset;">
...
import { NoticeRecord } from '@/interface/notice';
    ...
    const updateRead = async() => {
        ...
        await api.post('/read_notice', {record_id: props.item.id})
        props.getNotices()
