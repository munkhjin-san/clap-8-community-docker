        ...
        <div @mousedown.stop ref="detailWindow" class="chatCreate scrollable" style="padding-top: 0;">
            <div class="recordFormTitle" style="align-items: baseline;">
                ...
                <div style="margin-left: auto;padding-left: 20px;display: flex; align-items: center;position: relative;">
                    <div @click.stop="menu.setMenu( {name: 'noticeMenu', id: 256})" v-if="hasPrivilage" class="messageMenuContainer cursor-pointer" style="margin-left: auto; min-width: 30px;">
                    ...
                    <Transition name="modalFade">
                        <div id="noticeMenu" class="boxMenu boardMenuIcon" v-if="menu.name == 'noticeMenu' && menu.id == 256" style="top: 35px;right: 55px;z-index:6;">
                            <ul>
