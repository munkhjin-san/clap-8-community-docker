                        ...
                        <div class="flex w-full">
                            <div class="flex gap-2 items-center relative w-full">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <div class="flex relative" title="コメントバッジ" v-if="commentBadges(project.id) > 0">
                                        ...
                                        <div class="text-[white] absolute top-0 left-0 right-0 text-[10px] w-fit mx-auto">{{ commentBadges(project.id) }}</div>
                                    </div>
                                </div>
                            </div>                           
                        </div>
