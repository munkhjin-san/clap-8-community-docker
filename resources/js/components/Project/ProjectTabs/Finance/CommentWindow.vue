    ...
    <div class="gantt-overlay" @click="emit('close')">
        <div class="gantt-overlay-inner" ref="createModal" @click.stop>
            <div class="flex items-center h-[60px]">
                ...
                <h4 class="max-w-[calc(100% - 120px)] overflow-hidden overflow-ellipsis whitespace-nowrap">{{ type }} 
            ...
            <div class="c-b">
                ...
                <div class="c-b-i">
                    <div id="typeArea" @input="onInput" @keydown="onKeydown" ref="commentText" contenteditable="plaintext-only" class="typeBoxArea taskCommentArea"></div>
