                ...
                <table cellspacing="0" cellpadding="8" style="border-collapse: collapse">
                    ...
                    <tbody>
                        <tr v-for="grade in grades" style="text-align: center;">
                            <td style="border: solid thin var(--formBorder);">{{ grade.level }}</td>
                            <td style="border: solid thin var(--formBorder);">{{ grade.self }}</td>
                            <td style="border: solid thin var(--formBorder);">{{ grade.organization }}</td>
                            <td style="border: solid thin var(--formBorder);">{{ grade.society }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
