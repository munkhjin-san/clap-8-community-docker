                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="theme in themes" :key="theme" style="border-bottom: solid thin var(--formBorder);border-right: solid thin var(--formBorder);">
                            ...
                            <td @click="emit('selectThemeConfirm', level, theme)" class="selectable-theme" v-for="level in levels" :key="level">
                                <div style="padding: 10px;" v-for="issue in filteredIssues(level, theme)" :key="issue.id">
