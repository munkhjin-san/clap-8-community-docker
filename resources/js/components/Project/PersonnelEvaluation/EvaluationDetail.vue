<template>
    <div class="goals-wrap">
        <div style="overflow: hidden; position: relative;height:100%;">
            ...
            <div v-if="memberData && ((auth.id === memberData.id && auth.user?.position_id !== 13 )|| auth.id === memberData?.evaluation?.mentor?.id) && !projectEvaluations" title="新規作成" id="boardCreate" class="createBoardButton fileNewButton" @click="handleClick(0)" :style="{zIndex: 7}">
