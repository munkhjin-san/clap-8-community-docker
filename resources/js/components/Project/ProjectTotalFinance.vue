                                            ...
                                            <td v-if="showComment" class="sticky-right comment-cell">
                                                <div class="inner-col">
                                                    ...
                                                    <div class="flex items-center gap-2 cursor-pointer">
                                                        ...
                                                        <span class="side-notification" style="position: unset;background-color: #FFA500;" v-if="financeTotalBadge(proj.name)?.[periodStartIso]">{{ financeTotalBadge(proj.name)?.[periodStartIso] }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
