<template>
    <div class="gantt-body">
        ...
        <div title="" class="createBoardButton fileNewButton monthSiwtchButton !fixed"  @click.stop="menu.setMenu( {name : 'calendarViewMenu', id: 79})">
...
const switchView = (val:DateTimeUnit) => {
    menu.close()
    emit('setViewType', val)
}
</script>
<style scoped>
.gantt-content {
