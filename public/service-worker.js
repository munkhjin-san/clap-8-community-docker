...
self.addEventListener('push', function (e) {
  ...
  function () {
    ...
    regenerator.mark(function _callee2(payloadFromCallback) {
      var hideNotificationIfSiteHasFocus, title, body, icon, options, badge;
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
            ...
            case 8:
              ...
              badge = payloadFromCallback.data.badge;
              options = {
                body: body,
                icon: icon,
                badge: badge,
...
self.addEventListener('notificationclick', function (e) {
  ...
  var deepLink = isPusherNotification ? pusher.customerPayload.notification.deep_link : null;
    ...
    e.waitUntil(
      clients.matchAll({ type: 'window', includeUncontrolled: true }).then(clientsList => {
        ...
        for (const client of clientsList) {
          if(deepLink && client.url == deepLink){
            return client.focus()
          }
