...
return [
    ...
    */
    ...
    'google' => [
            ...
            'receipt_ocr_model' => env('GEMINI_RECEIPT_OCR_MODEL', 'models/gemini-3.5-flash'),
            'contact_enrich_model' => env('GEMINI_CONTACT_ENRICH_MODEL', 'models/gemini-3.5-flash'),
            'contact_scan_model' => env('GEMINI_CONTACT_SCAN_MODEL', 'models/gemini-3.5-flash'),
            'contract_ocr_model' => env('GEMINI_CONTRACT_OCR_MODEL', env('GEMINI_RECEIPT_OCR_MODEL', 'models/gemini-3.5-flash')),
            ...
            'contact_card_split_model' => env('GEMINI_CONTACT_CARD_SPLIT_MODEL', 'models/gemini-3.5-flash'),
    ],
